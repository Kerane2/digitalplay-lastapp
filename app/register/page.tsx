...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary/5 via-accent/5 to-background px-4 py-8 animate-fade-in">
      <Card className="w-full max-w-md shadow-2xl border-2 animate-fade-in-scale">
        <CardHeader className="text-center space-y-2">
          <CardTitle className="text-4xl font-bold">Inscription</CardTitle>
          <CardDescription className="text-base">
            Créez votre compte Digital Play
          </CardDescription>
        </CardHeader>
